...
exports.setupStatusCommands = exports.statusHandler = exports.clearStatuses = void 0;
// @ts-ignore
...
const generateToggleRoleHandler = ({ guild, name, roleName, onText, offText, channelName, description }) => {
    ...
    (0, commands_1.createCommand)(guild, { name, description, execute: handler });
...
const clearStatuses = (guild) => {
    const clearRole = (roleName) => {
        ...
        guild.members.cache.forEach((member) => {
            // @ts-ignore
            if (member.roles.cache.has(inebriatedRole.id))
                member.roles.remove(inebriatedRole);
        });
    };
...
exports.setupStatusCommands = setupStatusCommands;
